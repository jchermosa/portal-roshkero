...
public class DeviceAssignmentService {
    ...
    public DeviceAssignmentService(DeviceAssignmentRepository deviceAssignment, DispositivoService dispositivoService, DeviceRepository deviceRepository) {
    ...
    public DeviceAssignmentDTO crearAsignacion(DeviceAssignmentDTO deviceAssignmentDTO) {
        ...
        dispositivo.setEstado(EstadoInventario.A); // Cambiar estado a No Disponible
