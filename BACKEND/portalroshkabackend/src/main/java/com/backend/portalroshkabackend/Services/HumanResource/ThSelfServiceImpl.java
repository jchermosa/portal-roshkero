...
public class ThSelfServiceImpl implements IThSelfService {
    ...
    public EmailUpdatedDto updateEmail(int id, String newEmail) {
        ...
        Usuario savedUser = RepositoryService.saveEntity(() -> userRepository.save(user), "Error al guardar el usuario: ");// Este metodo recibe una funcion como primer parametro, y mensaje de error como segundo parametro, dentro de saveEntity se maneja el try/catch por si ocurre error al guardar la entidad.
    ...
    public RequestResponseDto sendRequest(int id, SendSolicitudDto sendSolicitudDto) {
        ...
        RepositoryService.saveEntity(() -> solicitudRepository.save(solicitud), "Error al guardar la solicitud: ");
    ...
    public RequestResponseDto updateRequest(int idSolicitud, UpdateSolicitudDto updateSolicitudDto) {
        ...
        RepositoryService.saveEntity(() -> solicitudRepository.save(request), "Error al actualizar la solicitud: ");
